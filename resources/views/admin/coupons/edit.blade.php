        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold">Chỉnh sửa mã giảm giá: {{ $coupon->code }}</h1>
                ...
                <form method="POST" action="{{ route('admin.coupons.update', $coupon) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div id="max-discount-field" class="{{ $coupon->type === 'percentage' ? '' : 'hidden' }}">
                            <label for="max_discount" class="block text-sm font-medium text-gray-700">Giảm tối đa (₫)</label>
                            <input type="number" id="max_discount" name="max_discount" value="{{ old('max_discount', $coupon->max_discount) }}" min="0" step="0.01"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <input type="number" id="min_order_amount" name="min_order_amount" value="{{ old('min_order_amount', $coupon->min_order_amount) }}" required min="0" step="0.01"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Đã sử dụng: {{ $coupon->used_count }} lượt</p>
                        </div>

                ...
                <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="parent_id" id="parent_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('description', $category->description) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            @if($category->getFirstMediaUrl('images'))
                                <div class="mb-2">
                                    <img src="{{ $category->getFirstMediaUrl('images') }}" alt="Current image" class="h-20 w-20 object-cover rounded">
                            ...
                            <p class="text-sm text-gray-500 mt-1">Chọn ảnh mới để thay thế (tùy chọn)</p>
                        </div>

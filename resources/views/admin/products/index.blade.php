                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($product->getFirstMediaUrl('images'))
                                            <img class="h-12 w-12 rounded object-cover" src="{{ $product->getFirstMediaUrl('images', 'thumb') }}" alt="{{ $product->name }}">
                                        @else
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <div>
                                            <div class="font-medium">₫{{ number_format($product->base_price) }}</div>
                                            @if($product->sale_price)
                                                <div class="text-red-600">₫{{ number_format($product->sale_price) }}</div>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('admin.products.edit', $product) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Sửa</a>

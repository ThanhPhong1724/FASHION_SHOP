...
@section('title', $category->name . ' - Fashion Shop')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            @if($category->children->count() > 0)
                <div class="mt-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-3">Danh mục con:</h3>
                        ...
                        @foreach($category->children as $child)
                            <a href="{{ route('categories.show', $child) }}" 
                               class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-800 hover:bg-gray-200">
                                {{ $child->name }}
                                <span class="ml-1 text-xs text-gray-500">({{ $child->products()->count() }})</span>
                            </a>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border">
                    ...
                    <form method="GET" action="{{ route('categories.show', $category) }}" id="filter-form">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('categories.show', $category) }}" class="flex-1 bg-gray-300 text-gray-700 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-400 text-center">
                                Xóa
                            </a>
                        </div>
                    </form>
